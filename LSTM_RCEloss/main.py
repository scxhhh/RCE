...
from LSTM_RCEloss import LSTM_RCE
...
def training(path,training_epochs,train_dropout_prob,hidden_dim,fc_dim,key,model_path,learning_rate=[1e-5, 2e-2],lr_decay=2000):
    ...
    # model built
    lstm = LSTM_RCE(input_dim, output_dim, hidden_dim, fc_dim,key)
...
def testing(path, hidden_dim, fc_dim, key, model_path):
    ...
    lstm_load = LSTM_RCE(input_dim, output_dim, hidden_dim, fc_dim, key)
...
if __name__ == "__main__":
   ...
   main(training_mode=1,data_path='../ranking_data', learning_rate=[1e-5, 2e-2],lr_decay=2000, training_epochs=1,dropout_prob=0.25,hidden_dim=256,fc_dim=128,model_path='../LSTM_RCEloss_model/',model_num=5)
